...
public class CellViewPlansFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_cell_view_plans, container, false);
        ...
        database.getReference().child("districts").child("huye").child("imihigo").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                districtPlansRecycleView.setAdapter(new PlansAdapter(getContext(), allImihigo, planKeysList, true, 1, auth.getCurrentUser().getUid(), auth.getCurrentUser().getEmail()));
            }
